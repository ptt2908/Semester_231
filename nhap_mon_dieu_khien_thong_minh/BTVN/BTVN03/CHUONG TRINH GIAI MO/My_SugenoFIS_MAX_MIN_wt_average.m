...
beta1 = min(x1_NB,x2_VL);
y1 = y_NB;

beta2 = min(x1_NB,x2_LO);
y2 = y_NB;

beta3 = min(x1_NB,x2_ME);
y3 = y_NM;

beta4 = min(x1_NB,x2_HI);
y4 = y_NS;

beta5 = min(x1_NS,x2_VL);
y5 = y_NM;

beta6 = min(x1_NS,x2_LO);
y6 = y_NM;

beta7 = min(x1_NS,x2_ME);
y7 = y_NS;

beta8 = min(x1_NS,x2_HI);
y8 = y_ZE;

beta9 = min(x1_ZE,x2_VL);
y9 = y_NS;

beta10 = min(x1_ZE,x2_LO);
y10 = y_ZE;

beta11 = min(x1_ZE,x2_ME);
y11 = y_ZE;

beta12 = min(x1_ZE,x2_HI);
y12 = y_PS;

beta13 = min(x1_PS,x2_VL);
y13 = y_ZE;

beta14 = min(x1_PS,x2_LO);
y14 = y_PS;

beta15 = min(x1_PS,x2_ME);
y15 = y_PM;

beta16 = min(x1_PS,x2_HI);
y16 = y_PM;

beta17 = min(x1_PB,x2_VL);
y17 = y_PS;

beta18 = min(x1_PB,x2_LO);
y18 = y_PM;

beta19 = min(x1_PB,x2_ME);
y19 = y_PB;

beta20 = min(x1_PB,x2_HI);
y20 = y_PB;
